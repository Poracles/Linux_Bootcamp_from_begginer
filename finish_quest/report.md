...
- Делаем миграцию **/var/log**.
    ...
    > Идея написать отчет пришла после проделанных действий, поэтому тут нет более подробного описания действий по миграции.
...
> Я не смог настроить общий буфер обмена с виртуальной машиной, поэтому много времени потратил на написание всех конфигов.
...
>
> Кстати, был опыт работы с Ubuntu v.20.04, там не было подсветки синтаксиса конфига netplan, по мне, тут совершен огромный прорыв в плане удобства работы...
...
## Проект: Развертывание отказоустойчивого веб-сервера (LEMP Stack) Выполнен!
