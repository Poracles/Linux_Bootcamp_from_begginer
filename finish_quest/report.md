...
0. [Подготовка](#01-подготовка)
    1.1. [Создаем отказоустойчивое хранилище](#создаем-отказоустойчивое-хранилище)
1. [1. Подготовка Базы Данных (MariaDB).](#1-подготовка-базы-данных-mariadb)
2. [2. Установка WordPress и phpMyAdmin.](#2-установка-wordpress-и-phpmyadmin)
    2.1 [2.1 WordPress (Сайт).](#21-wordpress-сайт)
    2.2 [2.2 **phpMyAdmin**](#22-phpmyadmin)
    2.3 [2.3. Права доступа.](#23-права-доступа)
3. [3. Настройка Nginx.](#3-настройка-nginx)
    3.1 [3.1. Сертификаты.](#31-сертификаты)
    3.2 [3.2. Конфиг виртуалхоста.](#32-конфиг-виртуалхоста)
    3.3 [3.3 Активация.](#33-активация)
4. [4. Финальная настройка.](#4-финальная-настройка)
    4.1 [4.1. Подключение.](#41-подключение)
    4.2 [4.2. Установки в браузере.](#42-установки-в-браузере)
    4.3 [4.3. Проверка защиты. ](#43-проверка-защиты)
5. [5. Бэкап.](#5-бэкап)
### 0.1 Подготовка
